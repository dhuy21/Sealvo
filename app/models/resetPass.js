...
class ResetPassword {
  async createResetPasswordToken() {
    try {
      ...
      console.error(
        'Erreur lors de la création du jeton de réinitialisation du mot de passe :',
        error
      );
      throw error;
    }
  ...
  async saveResetPasswordToken(email, token, expiresAt) {
    try {
      ...
      console.error(
        'Erreur lors de la sauvegarde du jeton de réinitialisation du mot de passe :',
        error
      );
      throw error;
    }
  ...
  async getResetPasswordToken(email) {
    try {
      ...
      console.error(
        'Erreur lors de la récupération du jeton de réinitialisation du mot de passe :',
        error
      );
      throw error;
    }
